        ...
        <div className={css.div2}>
          ...
          <div className={css.cards}>
            <Card5
              ...
              tag="Help users discover your place by creating a listing on Zomato"
              img={bookIcon}
              color="#FFFCF1"
            />
            <Card5
              ...
              tag="And deliver orders to millions of customers with ease"
              img={bikeIcon}
              color="#FFF5F6"
            />
            <Card5
              ...
              tag="Manage orders on our partner app, web dashboard or API partners"
              img={packageIcon}
              color="#FFF9F1"
            />
          </div>
