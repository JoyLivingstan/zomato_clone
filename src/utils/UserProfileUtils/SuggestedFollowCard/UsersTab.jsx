  ...
  return (
    <div className={css.userTab}>
        ...
        <div className={css.userData}>
          ...
          <div className={css.userDet}>
            <span className={css.txtBox}>
              <span className={css.count}>{data?.reviews}</span>{" "}
              <span className={css.txt1}>Reviews</span>
            </span>
            <span className={css.dot}></span>
            <span className={css.txtBox}>
              <span className={css.count}>{data?.followers}</span>{" "}
              <span className={css.txt2}>Followers</span>
            </span>
          </div>
        </div>
      </div>
      <div className={css.imgBox2}>
        <img
          className={css.followImg}
          src={follow ? friendImg : addUserImg}
          alt="follow icon"
          onClick={() => setFollow((val) => !val)}
        />
      </div>
    </div>
  );
