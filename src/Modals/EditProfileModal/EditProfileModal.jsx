...
const EditProfileModal = ({ setModal }) => {
  ...
  let validationSchema = Yup.object({
    ...
    phone: Yup.string()
      .min(10, "Minimum 3 charecters required!")
    ...
    description: Yup.string()
      ...
      .max(150, "Maximum 150 charecters only!"),
                ...
                return (
                  <Form className={css.form}>
                    ...
                    <span className={css.formTxt}>
                      ...
                      {150 - formik.values.description.length} characters
                      remaining)
                    </span>
                    <TextUtil name="handle" placeholder="Handle" />
                    <span className={css.formTxt}>
                      You can only change your handle once
                    </span>
